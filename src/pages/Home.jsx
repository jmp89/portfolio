...
const Home = () => {
  return (
    <>
      <section className="max-w-screen-lg mx-auto px-4 flex items-center flex-col justify-center h-[80%] mt-28 gap-40 sm:gap-20 sm:mt-56 sm:space-y-64 sm:max-w-screen-sm xl:space-x-8  xl:max-w-screen-xl xl:flex-row xl:mt-0 xl:mb-28 xl:h-full ">
        <div className="flex-1 flex justify-center">
          <Banner3D />
        </div>
        <article className="flex-1 p-4 z-10 w-full mt-40">
          <TextBox title={"Sobre mí"}>
            <p className="pr-6">
              Mi nombre es Juan Ignacio Macías Pérez, y soy de las Islas
              Canarias.
            </p>
          ...
          <nav className="mb-8">
            <ul className="flex content-between justify-start gap-4">
              ...
              <li className="hover:text-orange-500 cursor-pointer">
                <a href="https://github.com/jmp89" target="_blank">
                  <FaGithub size={"2rem"} />
                </a>
              </li>
              <li>
